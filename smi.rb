...
module SMI # Simple Menu Interface
	...
	def sni(title, message, icon = 0) # Simple Notification Interface
		dialog = Wx::MessageDialog.new(nil, message, title, Wx::DEFAULT_DIALOG_STYLE|Wx::RESIZE_BORDER|Wx::OK|Wx::CANCEL|icon)
